...
(function() {
  ...
  class QueueManager {
    ...
    _attachControls() {
      ...
      // Prev/Next only make sense with an actual queue behind them — hidden
      // by default in the player markup (a single track/episode has nothing
      // to skip to), shown here once a real multi-item queue exists.
